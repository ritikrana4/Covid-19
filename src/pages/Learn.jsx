        ...
        <div className='learn'>
                ...
                <div className='section-2'>
                    ...
                    <div className='grp-out'>
                        <div><img src='./assets/do-1.png'/></div>
                    ...
                    <div className='grp-out'>
                        <div><img src='./assets/do-2.png'/></div>
                        <div className='grp-in'>
                    ...
                    <div className='grp-out'>
                        <div><img src='./assets/do-3.png'/></div>
                        <div className='grp-in'>
                ...
                <div className='section-3'>
                    ...
                    <div className='grp-out'>
                        ...
                        <div className='image'><img src='./assets/do-1.png'/></div>
                    ...
                    <div className='grp-out'>
                        ...
                        <div className='image'><img src='./assets/do-2.png'/></div>
                    </div>
                    <div className='grp-out'>
                        ...
                        <div className='image'><img src='./assets/do-3.png'/></div>
